...
public class UseCaseThreadPoolScheduler implements UseCaseScheduler {
    ...
    @Override
    public <V extends UseCase.ResponseValue> void onError(final String errorCode, final Object errorMsg, final UseCase.UseCaseCallback<V> useCaseCallback) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                useCaseCallback.onError(errorCode,errorMsg);
            }
        });
    }
