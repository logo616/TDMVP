...
//                }
    ...
    private <V extends UseCase.ResponseValue> void notifyError(String errorCode,Object errorMsg,
            final UseCase.UseCaseCallback<V> useCaseCallback) {
        mUseCaseScheduler.onError(errorCode,errorMsg,useCaseCallback);
    }
    ...
    private static final class UiCallbackWrapper<V extends UseCase.ResponseValue> implements
        ...
        public void onError(String errorCode, Object errorMsg) {
            mUseCaseHandler.notifyError(errorCode,errorMsg,mCallback);
        }
