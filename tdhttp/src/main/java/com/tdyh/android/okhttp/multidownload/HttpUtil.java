...
public class HttpUtil {
    ...
    private final static long CONNECT_TIMEOUT = 3*60;//超时时间，秒
    private final static long READ_TIMEOUT = 15*60;//读取时间，秒
    private final static long WRITE_TIMEOUT = 15*60;//写入时间，秒
    ...
    public HttpUtil() {
        ...
        OkHttpClient.Builder builder = new OkHttpClient.Builder()
                ...
                .addInterceptor(new LoggerInterceptor("HttpUtil",true));

        mOkHttpClient = builder.build();

      /*  OkHttpClient.Builder builder = OkHttpUtil.getUnsafeOkHttpClient().newBuilder()
                .connectTimeout(CONNECT_TIMEOUT, TimeUnit.SECONDS)
                .writeTimeout(READ_TIMEOUT, TimeUnit.SECONDS)
                .readTimeout(WRITE_TIMEOUT, TimeUnit.SECONDS);
        mOkHttpClient = builder.build();*/
