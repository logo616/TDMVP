...
public class AndroidKeyStoreRSAUtils {
    ...
    public static final byte[] DEFAULT_SPLIT = "#TDYH#".getBytes();    // 当要加密的内容超过bufferSize，则采用partSplit进行分块加密
    public static final int DEFAULT_BUFFERSIZE = (DEFAULT_KEY_SIZE / 8) - 11;// 当前秘钥支持加密的最大字节数
    /**
     * 自己给你的别名，方便在keystore中查找秘钥
     */
    public static final String SAMPLE_ALIAS = "TDYH";
    ...
    public static KeyPair generateRSAKeyPair(Context context) throws
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {//android4.3
    ...
    public static PrivateKey getPrivateKey(String privateKeyData) {
        ...
        try {
            byte[] decodeKey = Base64.decode(privateKeyData,Base64.DEFAULT);
